alter table public.championship_event_team_players
	drop constraint championship_event_team_players_attendance_fk;
...
alter table public.championship_event_match_players
	drop constraint championship_event_match_players_event_id_player_id_fkey;

alter table public.championship_event_match_players
	add constraint championship_event_match_players_event_id_player_id_fkey
	foreign key (event_id, player_id)
	references public.championship_event_attendance (event_id, player_id)
	on delete no action
	deferrable initially immediate;
...
alter table public.championship_event_goals
	drop constraint championship_event_goals_match_id_scorer_player_id_fkey;

alter table public.championship_event_goals
	add constraint championship_event_goals_match_id_scorer_player_id_fkey
...
alter table public.championship_event_goals
	drop constraint championship_event_goals_match_id_assist_player_id_fkey;

alter table public.championship_event_goals
	add constraint championship_event_goals_match_id_assist_player_id_fkey
