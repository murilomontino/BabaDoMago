...
drop index if exists championship_events_championship_id_starts_at_idx;
...
drop policy if exists championship_events_select_member on public.championship_events;
...
drop policy if exists championship_event_teams_select_member
...
drop policy if exists championship_event_team_players_select_member
...
drop policy if exists championship_event_matches_select_member
...
revoke all on function public.soft_delete_championship_event(bigint) from public;
grant execute on function public.soft_delete_championship_event(bigint) to authenticated;
