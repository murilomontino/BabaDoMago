drop function if exists public.start_championship_event(bigint, date, jsonb, jsonb);
...
revoke all on function public.create_championship_event(bigint, date) from public;
revoke all on function public.save_championship_event_teams(bigint, jsonb, jsonb) from public;

grant execute on function public.create_championship_event(bigint, date) to authenticated;
grant execute on function public.save_championship_event_teams(bigint, jsonb, jsonb) to authenticated;
