...
drop function if exists public.save_championship_event_attendance(bigint, jsonb);
drop function if exists public.save_championship_event_teams(bigint, jsonb, jsonb);
...
begin
	...
	set is_goalkeeper = (a.player_id = any (goalkeeper_ids))
	where a.event_id = event.id
...
revoke all on function public.save_championship_event_attendance(bigint, jsonb, jsonb) from public;
revoke all on function public.save_championship_event_teams(bigint, jsonb, jsonb, jsonb) from public;

grant execute on function public.save_championship_event_attendance(bigint, jsonb, jsonb) to authenticated;
grant execute on function public.save_championship_event_teams(bigint, jsonb, jsonb, jsonb) to authenticated;
