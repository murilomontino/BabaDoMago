create or replace function public.undo_championship_event_goal(match_id bigint)
returns jsonb
language plpgsql
security definer
...
revoke all on function public.undo_championship_event_goal(bigint) from public;
grant execute on function public.undo_championship_event_goal(bigint) to authenticated;
