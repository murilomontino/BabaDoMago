...
| Cancelar efeito | só o **dono**; soft-delete (`player_votes_voided_at`): notas voltam, votos **permanecem**; histórico na aba **Gestão** |
| Reativar efeito | só o **dono**; limpa void e reaplica `vote_rating_delta` via sync |
...
Fonte: [`src/const/event-player-vote.ts`](../src/const/event-player-vote.ts), RPCs `submit_championship_event_player_votes`, `void_championship_event_player_votes`, `restore_championship_event_player_votes`.
...
| Voto do elenco | [`src/const/event-player-vote.ts`](../src/const/event-player-vote.ts), `submit_championship_event_player_votes`, `void_championship_event_player_votes`, `vote_rating_delta` |
