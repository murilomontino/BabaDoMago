...
export const SAFE_AREA_CLASS =
	"pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] pl-[max(1.25rem,env(safe-area-inset-left))] pr-[max(1.25rem,env(safe-area-inset-right))] sm:pl-[max(1.5rem,env(safe-area-inset-left))] sm:pr-[max(1.5rem,env(safe-area-inset-right))]";
...
export const PAGE_SHELL_CLASS = `mx-auto max-w-7xl px-5 py-8 sm:px-6 ${SAFE_AREA_CLASS}`;
