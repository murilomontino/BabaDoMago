...
function asAttendanceFromRow(
	...
	return {
		...
		line_wins: rowNumber(row, "line_wins") ?? 0,
		line_losses: rowNumber(row, "line_losses") ?? 0,
		line_draws: rowNumber(row, "line_draws") ?? 0,
		line_matches: rowNumber(row, "line_matches") ?? 0,
		gk_wins: rowNumber(row, "gk_wins") ?? 0,
		gk_losses: rowNumber(row, "gk_losses") ?? 0,
		gk_draws: rowNumber(row, "gk_draws") ?? 0,
		gk_matches: rowNumber(row, "gk_matches") ?? 0,
		...
		vote_rating_applied: rowNumber(row, "vote_rating_applied") ?? 0,
		goalkeeper_vote_rating_applied:
			rowNumber(row, "goalkeeper_vote_rating_applied") ?? 0,
