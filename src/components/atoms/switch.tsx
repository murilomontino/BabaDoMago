...
const SWITCH_THUMB_CLASS = `pointer-events-none block size-5 shrink-0 rounded-full bg-white shadow-sm transition-[translate] ${SWITCH_TRANSITION} data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0.5`;
