...
type DeleteEventAttendanceModalProps = {
	playerName: string;
	isPending: boolean;
...
export function DeleteEventAttendanceModal({
	playerName,
	isPending,
	errorMessage,
	onCancel,
	onConfirm,
}: DeleteEventAttendanceModalProps) {
	return (
		<AppDialog onClose={onCancel}>
			<div className={MODAL_CLASS}>
				<p className="mb-1 text-sm font-medium tracking-tight text-fg">
					{EVENT_ACTION.removeAttendance}
				</p>
				<p className="mb-3 text-sm text-fg-muted">
					{playerName} sai da lista de presentes.
				</p>
				{errorMessage && (
